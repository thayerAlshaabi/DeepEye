...
class New_Toplevel_1:
    def __init__(self, top=None):
        ...
        self.Threshold.configure(textvariable=GUI_support.ThresholdBox)
        ...
        self.CustomWindowCheck.configure(variable=GUI_support.cpd53)
        ...
        self._img1 = PhotoImage(file="./eye.gif")
